...
const main = () => {
  ...
  console.log(`items[0] - id:${items[0].id}, fistName:${items[0].firstName}, age:${items[0].age}`);
  console.log(`items[1] - id:${items[1].id}, fistName:${items[1].firstName}, age:${items[1].age}`);
};
